 ...
 * @since AM 5.5.0
 */
public class JDBCAuthNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(JDBCAuthNodePlugin.currentVersion, 
				Collections.singletonList(JDBCAuthNode.class));
	}
	...
	public String getPluginVersion() {
		return JDBCAuthNodePlugin.currentVersion;
	}
}
